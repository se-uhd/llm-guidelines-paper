...
Of course, it is better to report essential information in the \supplementarymaterial than not at all.
...
Depending on the specific study context, additional information regarding tool architecture or experiment setup \should be reported (see Section \toolarchitecture).
...
Prompts significantly influence the output of a model, and understanding how exactly they were formatted and integrated into an LLM-based study is essential to ensure transparency, verifiability, and reproducibility.
