...
\author{
    \IEEEauthorblockN{Sebastian Baltes\IEEEauthorrefmark{1}, Florian Angermeir\IEEEauthorrefmark{2}, Chetan Arora\IEEEauthorrefmark{3}, Marvin Muñoz Barón\IEEEauthorrefmark{4}, Lukas Böhme\IEEEauthorrefmark{5}, Fabio Calefato\IEEEauthorrefmark{6}, Chunyang Chen\IEEEauthorrefmark{4}, Neil Ernst\IEEEauthorrefmark{7}, Davide Falessi\IEEEauthorrefmark{8}, Brian Fitzgerald\IEEEauthorrefmark{9}, Davide Fucci\IEEEauthorrefmark{10}, Marcos Kalinowski\IEEEauthorrefmark{11}, Stefano Lambiase\IEEEauthorrefmark{12}, Mircea Lungu\IEEEauthorrefmark{13}, Lutz Prechelt\IEEEauthorrefmark{14}, Paul Ralph\IEEEauthorrefmark{15}, Christoph Treude\IEEEauthorrefmark{16}, Stefan Wagner\IEEEauthorrefmark{4}}
    
    \IEEEauthorblockA{\IEEEauthorrefmark{1}University of Bayreuth, Germany (sebastian.baltes@uni-bayreuth.de)}
    
    \IEEEauthorblockA{\IEEEauthorrefmark{2}fortiss, Germany, and Blekinge Institute of Technology, Sweden (angermeir@fortiss.org)}

    \IEEEauthorblockA{\IEEEauthorrefmark{3}Monash University, Australia (chetan.arora@monash.edu)}

    \IEEEauthorblockA{\IEEEauthorrefmark{4}Technical University of Munich, Germany (\{marvin.munoz-baron, stefan.wagner\}@tum.de)}

    \IEEEauthorblockA{\IEEEauthorrefmark{5}HPI, University of Potsdam, Germany (lukas.boehme@hpi.de)}

    \IEEEauthorblockA{\IEEEauthorrefmark{6}University of Bari, Italy (fabio.calefato@uniba.it)}

    \IEEEauthorblockA{\IEEEauthorrefmark{7}University of Victoria, Canada (nernst@uvic.ca)}

    \IEEEauthorblockA{\IEEEauthorrefmark{8}University of Rome ``Tor Vergata'', Italy (falessi@ing.uniroma2.it)}

    \IEEEauthorblockA{\IEEEauthorrefmark{9}Lero and University of Limerick, Ireland (brian.fitzgerald@ul.ie)}   

    \IEEEauthorblockA{\IEEEauthorrefmark{10}Blekinge Institute of Technology, Sweden (davide.fucci@bth.se)}

    \IEEEauthorblockA{\IEEEauthorrefmark{11}Pontifical Catholic University of Rio de Janeiro, Brazil (kalinowski@inf.puc-rio.br)}

    \IEEEauthorblockA{\IEEEauthorrefmark{12}University of Salerno, Italy (slambiase@unisa.it)}

    \IEEEauthorblockA{\IEEEauthorrefmark{13}IT University of Copenhagen, Denmark (mlun@itu.dk)}

    \IEEEauthorblockA{\IEEEauthorrefmark{14}Free University of Berlin, Germany (prechelt@inf.fu-berlin.de)}

    \IEEEauthorblockA{\IEEEauthorrefmark{15}Dalhousie University, Canada (paulralph@dal.ca)}

    \IEEEauthorblockA{\IEEEauthorrefmark{16}Singapore Management University, Singapore (ctreude@smu.edu.sg)}
}
...
The most recent version is always available online\footnote{https://llm-guidelines.org/}; other researchers can suggest changes via a public GitHub repository.
...
\subsubsection{LLMs as Tools for Software Engineers}
...
Our guidelines are structured as follows:

\vspace{0.5\baselineskip}
\begin{enumerate}[label=\arabic*)]
    \item \emph{\usagerole}
    \item \emph{\modelversion}
    \item \emph{\toolarchitecture}
    \item \emph{\prompts}
    \item \emph{\humanvalidation}
    \item \emph{\openllm}
    \item \emph{\benchmarksmetrics}
    \item \emph{\limitationsmitigations}
\end{enumerate}
...
An example of an LLM disclosure beyond writing support can be found in a recent paper by Ludos et al.~\cite{DBLP:conf/re/LubosFTGMEL24}, in which they write in the methodology section:
