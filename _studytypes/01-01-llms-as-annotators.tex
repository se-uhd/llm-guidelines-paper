...
LLMs can be used to augment or replace human annotations, provide suggestions for new codes (see Section \synthesis), or even automate the entire qualitative data analysis process. \added{In some cases, human annotations or judgments may not be the appropriate gold standard; in these cases, LLM labels may need to be compared with other LLMs, or more objective metrics, such as whether a pull request resolves an issue.}
...
LLMs also show remarkably high inter-rater agreement, higher than crowd workers and trained annotators~\cite{DBLP:journals/corr/abs-2303-15056} in scenarios with high-clarity.
\comment{However, the Challenges section states that LLM consistency often falls below scientific reliability thresholds. We can revise this to scenarios with high-clarity.}
