...
\added{Again, the non-determinism of LLMs undermines replicability.} Evaluating tool effectiveness is challenging, as minor changes in input cause major differences in performance.
...
The obvious solution---using cloud-based APIs or relying on third-party providers for hosting---introduces new concerns related to data privacy and security.
