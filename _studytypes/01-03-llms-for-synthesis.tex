...
\added{All of the studies in the previous paragraph reported reducing time, cognitive demands, and resources required for qualitative research.}
\added{Furthermore, a key advantage is the automation of tasks previously executed by humans.}
As discussed, qualitative research does not scale well to large samples and using LLMs allows researchers to analyze larger qualitative datasets~\cite{DBLP:journals/ase/BanoHZT24,barros2024largelanguagemodelqualitative, leça2024applicationsimplicationslargelanguage}.
