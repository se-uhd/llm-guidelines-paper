...
The underlying statistical framework of an LLM usually pushes outputs towards the most likely (majority) answer. That majority answer might still be incorrect. 
