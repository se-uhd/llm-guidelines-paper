...
Regarding systematic error, LLMs may suffer from well-documented biases and issues with fairness~\cite{Gallegos2024BiasAF} (e.g. assessing discussions of pull requests). 
