...
\newcommand{\reviewText}[1]{{\textcolor{purple}{#1}}}
...
% MAY — DEPRECATED: retained only for backward compatibility during
% the revision.  All former MAY items All former MAY items should be reworded as plain
% suggestions (e.g., "researchers may / can …"), without small capitals formatting.
...
\added{\paragraph{Authorship:} All authors of this paper not only contributed content but also stand behind the criteria outlined in the guidelines beyond their own contribution. }
