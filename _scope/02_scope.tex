...
Although the checklist overlaps with our \guidelines (e.g., reporting the LLM name and version, reporting how performance was compared to \enq{other LLMs, humans and other benchmarks or standards}), they are healthcare-specific (e.g., they require to \enq{explain the healthcare context} and \enq{therapeutic and clinical workflow}).
