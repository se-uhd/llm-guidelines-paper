...
Although their guidelines partially overlap with ours (e.g., repeating experiments to handle output variability, considering data leakage), our guidelines cover a broader range of study types and provide more detailed advice.
...
\scopeparagraph{Focus on Natural Language and Code Use Cases}

We want to clarify that our focus is on LLMs, that is, natural language and code use cases.
...
However, our guidelines could be extended in the future to include foundational models beyond natural language text and code.
