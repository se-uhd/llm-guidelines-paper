...
\begin{framed}
\summary: %
\input{_tldr/01_declare-llm-usage-and-role-tldr.tex}\end{framed}
...
\begin{framed}
\summary: %
\input{_tldr/02_report-model-version-configuration-and-customizations-tldr.tex}\end{framed}
...
\begin{framed}
\summary: %
\input{_tldr/03_report-system-and-prompt-design-tldr.tex}\end{framed}
...
\begin{framed}
\summary: %
\input{_tldr/04_report-session-traces-tldr.tex}\end{framed}
...
\begin{framed}
\summary: %
\input{_tldr/05_use-baselines-benchmarks-and-metrics-tldr.tex}\end{framed}

\input{_guidelines/05_use-baselines-benchmarks-and-metrics.tex}
...
\begin{framed}
\summary: %
\input{_tldr/06_use-an-open-llm-as-a-baseline-tldr.tex}\end{framed}
...
\begin{framed}
\summary: %
\input{_tldr/07_use-human-validation-for-llm-outputs-tldr.tex}\end{framed}

\input{_guidelines/07_use-human-validation-for-llm-outputs.tex}
...
\begin{framed}
\summary: %
\input{_tldr/08_report-limitations-and-mitigations-tldr.tex}\end{framed}
