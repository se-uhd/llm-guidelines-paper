...
\midrule
4.1   & \textbf{\llmsforresearcher} \\
4.1.1 & \quad \annotators \\
4.1.2 & \quad \judges \\
4.1.3 & \quad \synthesis \\
4.1.4 & \quad \subjects \\
\midrule
4.2   & \textbf{\llmsforengineers} \\
4.2.1 & \quad \llmusage \\
4.2.2 & \quad \newtools \\
4.2.3 & \quad \benchmarkingtasks \\
\bottomrule
\end{tabular}
\end{table}
...
\todo{Move to table, use full section names here}
...
\input{_tldr/_checklist/checklist.tex}