...
\else
  ...
  \newcommand{\toolarchitecture}{\href{/guidelines\#report-tool-architecture-beyond-models}{\emph{Architecture}}\xspace}
  \newcommand{\humanvalidation}{\href{/guidelines\#use-human-validation-for-llm-outputs}{\emph{Human Validation}}\xspace}
  \newcommand{\prompts}{\href{/guidelines\#report-prompts-their-development-and-interaction-logs}{\emph{Prompts and Logs}}\xspace}
...
\begin{table}[tb]
\caption{Applicability of guidelines to study types. \iconM~=~\must, \iconS~=~\should.
