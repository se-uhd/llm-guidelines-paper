...
\begin{itemize}[label=$\square$]
    ...
    \item \iconM Publish all prompts and prompt templates, including their structure, content, formatting, and dynamic components, as \supplementarymaterial~(G4).
