...
\end{revcomment}
\begin{revresponse}
    \todo{Somehow merge the advantages. Maybe move some up to 4.1.1 and then refer to them?}
\end{revresponse}
...
\end{revcomment}
\begin{revresponse}
    \todo{Add this as the overarching advantage.}
\end{revresponse}
...
\end{revcomment}
\begin{revresponse}
    \todo{Not sure what the ``please'' is about. Add replicability to the challenges.}
\end{revresponse}
...
\end{revcomment}
\begin{revresponse}
    \todo{Interesting idea but would need quite some work: Should we add a reviewer guideline?}
\end{revresponse}
