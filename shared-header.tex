...
% RFC 2119 keywords
\ifpaper
  \newcommand{\must}{must\xspace}
  \newcommand{\mustnot}{must not\xspace}
  \newcommand{\should}{should\xspace}
  \newcommand{\shouldnot}{should not\xspace}
\else
...
% Summary label
\ifpaper
  \newcommand{\tldr}{\underline{\emph{Summary}}\xspace}
\else
  \newcommand{\tldr}{\textbf{\emph{Summary}}\xspace}
\fi
