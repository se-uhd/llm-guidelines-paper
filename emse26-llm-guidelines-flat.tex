...
\hyperref[sec:use-suitable-baselines-benchmarks-and-metrics]{Benchmarks}
  ...
  & \iconM % benchmarkingtasks: "of primary importance: must use established benchmarks or rigorously justify the creation of new ones, must report standard metrics", "should report an error analysis alongside the primary scores"
  \\
