...
\begin{itemize}[label=$\rightarrow$]
    ...
    \item Section~\hyperref[sec:use-suitable-baselines-benchmarks-and-metrics]{\ref*{sec:use-suitable-baselines-benchmarks-and-metrics}}: Use Suitable Baselines, Benchmarks, and Metrics.
