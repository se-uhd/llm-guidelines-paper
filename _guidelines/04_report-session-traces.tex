...
\guidelinesubsubsection{Example}
...
\begin{itemize}[label=$\rightarrow$]
    \item Section~\hyperref[sec:report-system-and-prompt-design]{\ref*{sec:report-system-and-prompt-design}}: Report System and Prompt Design.
