...
\comment{In the LLM-as-a-Judge section, it said Depending on the model configuration, LLMs can provide relatively consistent evaluations.}
...
\comment{I think we better use some software engineering examples here. This paragraph is more general, as it talks about natural language processing tasks more.}
...
Crucially, for tasks involving subjectivity or uncertainty, researchers should explicitly acknowledge the existence of multiple valid ground truths rather than forcing a single ``gold standard''.
