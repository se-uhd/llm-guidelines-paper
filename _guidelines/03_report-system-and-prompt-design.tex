...
Researchers \must describe which context-file mechanisms were used and \should publish the full contents as \supplementarymaterial, because they shape agent behavior similarly to system prompts.
...
\begin{itemize}[label=$\rightarrow$]
    \item Section~\hyperref[sec:report-model-version-configuration-and-customizations]{\ref*{sec:report-model-version-configuration-and-customizations}}: Report Model Version, Configuration, and Customizations.
    \item Section~\hyperref[sec:report-session-traces]{\ref*{sec:report-session-traces}}: Report Session Traces.
    \item Section~\hyperref[sec:use-human-validation-for-llm-outputs]{\ref*{sec:use-human-validation-for-llm-outputs}}: Use Human Validation for LLM Outputs.
    \item Section~\hyperref[sec:use-an-open-llm-as-a-baseline]{\ref*{sec:use-an-open-llm-as-a-baseline}}: Use an Open LLM as a Baseline.
    \item Section~\hyperref[sec:report-limitations-and-mitigations]{\ref*{sec:report-limitations-and-mitigations}}: Report Limitations and Mitigations.
\end{itemize}
