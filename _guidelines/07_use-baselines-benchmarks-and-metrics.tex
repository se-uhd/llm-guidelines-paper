...
\begin{itemize}
    \item \must briefly justify selected benchmarks and metrics in the \paper. 
    ...
    \item \may include an example of a task and the corresponding test case(s) to illustrate the structure of the benchmark.
\end{itemize}
...
Using LLMs might be unreasonable if less resource-hungry approaches achieve similar performance. 
