...
Clear documentation of the architecture and the supplemental data that was used enables comparison and upholds scientific rigor and accountability, fostering reliable and reusable research.
...
\added{As in the previous subsection, in most cases, reviewers should simply request any missing information be added unless so much information is missing that the review cannot assess methodological rigor. For this guideline, reviewers may question whether the \textit{paper} (not the only supplement) includes sufficient description of the system and may (hopefully using our recommendations) ask authors to shift selective details from supplements to the paper body. }


%%Paul: I'm thinking through some of these issues around proprietary systems for the first time and could do with a sanity check on this paragaph. In general I'm skeptical of anyone trying to take scientific credit for proprietary or confidential technologies. The purpose of science is to undersand and improve the world. Secrecy impedes both. What are the arguments for accepting a paper about a technology when we can't access the tech or even a fullsome description of how it works?
\added{For reviewers, the most difficult questions here surround the use of proprietary or confidential components. Broadly, empirically evaluating an artifact is always a scientific contribution regardless of how opaque the artifact is. However, the more inscrutable and less available an invention, the less it counts as a scientific contribution. Finally, reviewers should \textit{not} accept proprietary or confidential \textit{scientific instruments}. The means of study (tools, instruments, metrics, scales, interview guides, experimental materials, etc.) must be fully disclosed, even when the object under study is not.}